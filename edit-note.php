...
if(isset($_POST['submit'])){
  ...
  if($status == 200 ){
    header('location:view-note.php?id=' . $_POST['id']);
    exit;
  }
      ...
      <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0">
        <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
          <div>
            ...
            <h4 class="mg-b-0 tx-spacing--1">Edit note</h4>
          </div>
        </div>
        ...
        <div class="row row-xs">
          <div class="col-lg-2">
            <form action="" method="POST">
              <input type="text" name="id" value="<?php echo $note['id']; ?>" class="form-control" placeholder="ID" hidden>
              <div class="form-group">
                <input type="text" name="title" value="<?php echo $note['title']; ?>" class="form-control" placeholder="Title">
              </div>
              <div class="form-group">
                <textarea class="form-control" name="content" rows="5" placeholder="Content"><?php echo $note['content']; ?></textarea>
              </div>

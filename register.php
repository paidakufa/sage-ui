...
if(isset($_POST['register'])){
  ...
  curl_setopt_array($curl, array(
      CURLOPT_URL => 'localhost:8010/api/register',
            ...
            <div class="sign-wrapper mg-lg-r-50 mg-xl-r-60">
              <div class="pd-t-20 wd-100p">
                ...
                <div class="form-group">
                  <label>Name</label>
                  <input type="text" name="name" class="form-control" placeholder="Enter your firstname">
                </div>
                <div class="form-group">
                ...
                <button name="register" type="submit" class="btn btn-brand-02 w-100">Create Account</button>
